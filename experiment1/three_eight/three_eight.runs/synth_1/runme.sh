...
HD_PWD='G:/myfpga/nexys/three_eight/three_eight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log three_eight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source three_eight.tcl
