...
HD_PWD='G:/myfpga/nexys/three_eight/three_eight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log three_eight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source three_eight.tcl -notrace
